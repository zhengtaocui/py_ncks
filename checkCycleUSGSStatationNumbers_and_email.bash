...
/gpfs/hps3/nwc/noscrub/Zhengtao.Cui/py_ncks_sss_copy/plotRealtimeCycleUSGSStatationNumbers.py -i /gpfs/hps3/ptmp/Zhengtao.Cui/cycle_${casetype}_num_of_stations/real_time_station_numbers.txt -o CycleNumberOf${casetype^^}Stations.pdf -t "${casetype^^} number of stations by cycle" > /gpfs/hps3/ptmp/Zhengtao.Cui/cycle_${casetype}_num_of_stations/plot.log 2>&1
