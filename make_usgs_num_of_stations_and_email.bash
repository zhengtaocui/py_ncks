...
if [ ! -e "/gpfs/hps3/ptmp/Zhengtao.Cui/usgs_num_of_stations" ]; then mkdir -p /gpfs/hps3/ptmp/Zhengtao.Cui/usgs_num_of_stations; fi

cd /gpfs/hps3/ptmp/Zhengtao.Cui/usgs_num_of_stations

/gpfs/hps3/nwc/noscrub/Zhengtao.Cui/py_ncks_sss_copy/checkUSGSStatationNumbers.py -d /gpfs/hps/nco/ops/com/nwm/prod -s $startpdy -e $endpdy > /gpfs/hps3/ptmp/Zhengtao.Cui/usgs_num_of_stations/prod.log 2>&1
