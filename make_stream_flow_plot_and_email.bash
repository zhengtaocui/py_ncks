...
/gpfs/hps/nwc/noscrub/Zhengtao.Cui/py_ncks_sss_copy/plotStreamFlow.py -d /gpfs/hps/ptmp/Zhengtao.Cui/com2/nwm/test -s $startpdy -e $endpdy -u 07064533 --title "V1.1 fixed dev USGS07064533 stream flow" --sr 2017061300,2017061306,2017061400 --tm0= --tm1= --tm2= -o v1_1_fixed_dev_USGS07064533 > /gpfs/hps/ptmp/Zhengtao.Cui/stream_flow_plot/para_fixed.log 2>&1
...
echo -e "V1.1: v1_1_not_fixed_prod_USGS07064533.pdf\nV1.2dev: v1_2_fixed_dev_USGS07064533.pdf\nV1.2prod: v1_2_not_fixed_dev_USGS07064533.pdf " | mail -s "USGS 07064533 Stream flow" -a  v1_1_not_fixed_prod_USGS07064533.pdf -a v1_2_fixed_dev_USGS07064533.pdf -a v1_2_not_fixed_dev_USGS07064533.pdf -a v1_1_not_fixed_dev_USGS07064533.pdf -r 'Zhengtao.Cui@noaa.gov' Zhengtao.Cui@noaa.gov
