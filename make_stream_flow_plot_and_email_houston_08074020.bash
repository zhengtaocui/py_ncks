...
/gpfs/hps3/nwc/noscrub/Zhengtao.Cui/py_ncks_sss_copy/plotStreamFlow.py -d /gpfs/hps/nco/ops/com/nwm/prod -s $startpdy -e $endpdy -u 08074020 --title "V1.1 not fixed prod USGS08074020 stream flow" --sr $srpdyh1,$srpdyh3,$srpdyh4 --mr $srpdyh2 --tm0= --tm1= --tm2= -o v1_1_not_fixed_prod_USGS08074020 > /gpfs/hps3/ptmp/Zhengtao.Cui/stream_flow_plot/prod.log 2>&1
